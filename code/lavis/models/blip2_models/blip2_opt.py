...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        opt_model = "/root/PreTrainModel/facebook-opt2.7b"
        self.opt_tokenizer = AutoTokenizer.from_pretrained(opt_model, use_fast=False, local_files_only=True)
        self.opt_model = OPTForCausalLM.from_pretrained(
            opt_model, torch_dtype=torch.float16, local_files_only=True
        )
